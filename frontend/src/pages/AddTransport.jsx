            ...
            <Panel title="Global Navigation Links" index="02" icon={<Globe size={16} className="animate-pulse text-white/10" />}>
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <Field label="Origin Terminal" icon={<MapPin className="text-orange-500" size={18} />}>
                  <input name="routeFrom" value={formData.routeFrom} onChange={handleChange} required placeholder="ORIGIN TERMINAL" className={inputClass} />
                </Field>
                <Field label="Destination Hub" icon={<Navigation className="text-orange-500" size={18} />}>
                  <input name="routeTo" value={formData.routeTo} onChange={handleChange} required placeholder="DESTINATION HUB" className={inputClass} />
                </Field>
              </div>
            </Panel>
