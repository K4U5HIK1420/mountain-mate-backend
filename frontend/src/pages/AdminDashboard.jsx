...
function RideDetailsPanel({ selected }) {
          ...
          {RIDE_DOC_FIELDS.map(([key, label]) => {
            ...
            return (
              <div key={key} className="rounded-xl border border-white/10 bg-black/25 p-3">
                ...
                {ok ? (
                  <a href={url} target="_blank" rel="noreferrer" className="text-xs text-orange-300 underline">
                    Open file
                  </a>
                ) : null}
              </div>
...
function HotelDetailsPanel({ selected }) {
